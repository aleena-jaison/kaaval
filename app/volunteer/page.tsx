      ...
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Join the Kaaval team to help care for our community's dogs.</p>
          </div>
        </div>
          ...
          <form action={async () => {
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Users className="h-5 w-5 text-blue-500" /> Volunteer Application
              </CardTitle>
              <CardDescription>We're always looking for passionate individuals to help with feeding, walking, and caring for the dogs.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <select id="availability" name="availability" required className="flex h-11 w-full rounded-full border border-border bg-background px-4 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2">
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    placeholder="Tell us if you have veterinary experience, dog training skills, or just love spending time with dogs..."
                    required
                  />
                </div>
              </div>
